<template>
  <NuxtLayout name="authentication">
    <template #navbar>
      <NavbarTransparent is-blur="blur border-radius-lg my-3 py-2 start-0 end-0 mx-4 shadow"
            ...
            <div class="card border-0 mb-0">
              ...
              <div class="card-body px-lg-5 pt-0">
                ...
                <form role="form" class="text-start">
                  ...
                  <div class="text-center">
                    <ArgonButton color="dark" variant="gradient" full-width class="mt-2 mb-4">Sign up</ArgonButton>
                  </div>
                </form>
              </div>
            </div>
